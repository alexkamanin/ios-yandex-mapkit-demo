 ...
 */
final class CustomLayerViewController: UIViewController {
    
    private final let mainView = UICustomLayerView()
    ...
    override func viewDidLoad() {
        ...
        self.mainView.map.mapWindow.map.mapType = .none
        ...
        layer = self.mainView.map.mapWindow.map.addLayer(
